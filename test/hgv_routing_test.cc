...
public:
  ...
  osr::path route(osr::profile_parameters const& params,
                  ...
                  std::optional<osr::routing_time_t> const start_time =
                      std::nullopt) const {
    auto result = osr::route(
        params, *ways_, *lookup_, profile, from, to,
        std::chrono::seconds{10000}, osr::direction::kForward, 50.0, nullptr,
        nullptr, nullptr, osr::routing_algorithm::kDijkstra, start_time);
