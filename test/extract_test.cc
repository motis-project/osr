...
TEST(extract, wa) {
  ...
  //                   right_node, w.node_to_osm_[right_node], right_dist,
  //                   d.way_, d.right_path_);
  //    }
  //
  ...
  //        "{}",
  //        osr::to_geojson(
  //            w, &s, left_node != node_idx_t::invalid() ? &d.left_path_ :
  //            nullptr, right_node != node_idx_t::invalid() ? &d.right_path_ :
  //            nullptr));
  //
  //    break;
  //  }
